...
const STR: { vi: FaqStrings; en: FaqStrings } = {
  vi: {
    ...
    ctaBody:
      "Đội ngũ Uniemarket luôn sẵn sàng hỗ trợ bạn. Nhắn cho chúng tôi và nhận phản hồi trong ít phút.",
  ...
  en: {
    ...
    subtitle:
      "Quickly find answers to the most common questions about buying items at Uniemarket.",
    ...
    ctaBody:
      "The Uniemarket team is always ready to help. Message us and get a reply within minutes.",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "A Uniemarket staff member joins that same game, friends you or hops into the same server, and hands the item directly to your Roblox character through the in-game trade feature.",
      },
      {
        id: "delivery-3",
        category: "delivery",
      ...
      },
      {
        id: "safety-1",
        category: "safety",
        question: "Is it safe to buy items from Uniemarket?",
        answer:
      ...
      },
      {
        id: "safety-2",
        category: "safety",
        question: "Does Uniemarket ask for my Roblox password?",
        answer:
