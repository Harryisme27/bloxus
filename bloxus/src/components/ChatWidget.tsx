...
const STR = {
  vi: {
    ...
    loginPrompt: "Đăng nhập để nhắn tin với đội ngũ Bloxus về đơn hàng của bạn.",
    login: "Đăng nhập",
    faq: "Câu hỏi thường gặp",
    demoNotice: "(Chưa kết nối cơ sở dữ liệu — xem SETUP.md.)",
    ...
    dialogAria: "Khung chat hỗ trợ Bloxus",
    supportTitle: "Hỗ trợ Bloxus",
  ...
  en: {
    ...
    loginPrompt: "Log in to message the Bloxus team about your order.",
    login: "Log in",
    faq: "Frequently asked questions",
    demoNotice: "(No database connected — see SETUP.md.)",
    ...
    dialogAria: "Bloxus support chat",
    supportTitle: "Bloxus support",
