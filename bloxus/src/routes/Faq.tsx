  ...
  vi: {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Nếu bạn muốn góp ý hoặc có game mới muốn chúng tôi bán, hãy tham gia Discord BLOXUS tại https://discord.gg/txxbJQR4GN và nhắn cho chúng tôi — mọi đề xuất đều được đội ngũ đọc và phản hồi.",
      },
    ],
  },
  en: {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "If you'd like to give feedback or there's a new game you want us to sell, join the BLOXUS Discord at https://discord.gg/txxbJQR4GN and message us — the team reads and responds to every suggestion.",
      },
    ],
  },
};
