  ...
  vi: {
    ...
    steps: [
      ...
      },
      {
        title: "Thanh toán",
        description:
          "Nhập username Roblox và hoàn tất thanh toán an toàn qua thẻ (Stripe) hoặc ví Bloxus.",
      },
      {
  ...
  en: {
    ...
    steps: [
      ...
      },
      {
        title: "Checkout",
        description:
          "Enter your Roblox username and complete a secure payment by card (Stripe) or with your Bloxus wallet.",
      },
      {
