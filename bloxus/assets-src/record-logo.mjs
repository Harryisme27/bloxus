...
const scene = "file:///D:/Market/uniemarket/assets-src/logo-scene.html";
...
await p2.screenshot({ path: "D:/Market/uniemarket/public/logo-poster.png" });
await ctx.close();
await browser.close();
copyFileSync(videoPath, "D:/Market/uniemarket/public/logo.webm");
console.log("saved");
