# Bloxus — Bản demo cửa hàng vật phẩm Roblox
...
2. Hoặc tốt hơn: **copy toàn bộ thư mục `bloxus` ra ngoài OneDrive**, ví dụ chuyển tới
   `C:\Bloxus`, rồi chạy `start.bat` từ đó.
...
(hoặc *Storage*) → *Local Storage* → xoá các mục bắt đầu bằng `bloxus-`.
