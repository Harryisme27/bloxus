-- ============================================================================
-- BLOXUS V2 — 02-seed.sql (TÙY CHỌN)
-- ----------------------------------------------------------------------------
...
values
  ('adopt-me', 'Adopt Me', 'The most-played pet-trading game on Roblox.',
   'Adopt Me là tựa game nuôi và giao dịch thú cưng nổi tiếng nhất Roblox. Tại Bloxus, bạn có thể mua các thú cưng Legendary, Rare hiếm có khó tìm với giá tốt và giao hàng nhanh chóng.',
   '#7BD0F0', 'Username Roblox', 'VD: RobloxPlayer123', 1, true, true),
  ('murder-mystery-2', 'Murder Mystery 2', 'Iconic MM2 knives and guns.',
   'Murder Mystery 2 (MM2) nổi tiếng với các con dao (knife) và súng Chroma, Godly cực đẹp. Bloxus cung cấp đầy đủ các vật phẩm Godly hot nhất với độ uy tín cao.',
  ...
  ('grow-a-garden', 'Grow a Garden', 'Rare pollinating pets and seed bundles.',
   'Grow a Garden là game trồng trọt kết hợp thú cưng thụ phấn đang gây sốt. Sở hữu ngay các thú cưng Godly, Mythical hiếm và bundle hạt giống chỉ có tại Bloxus.',
  ...
  ('pet-simulator-99', 'Pet Simulator 99', 'Huge and Titanic pets plus Diamonds.',
   'Pet Simulator 99 nổi bật với các thú cưng khổng lồ Huge và Titanic cực kỳ hiếm, cùng nguồn Diamonds dồi dào. Giao dịch an toàn, nhanh chóng tại Bloxus.',
  ...
  ('steal-a-brainrot', 'Steal a Brainrot', 'Collect the viral brainrot characters.',
   'Steal a Brainrot cho phép bạn sưu tầm các nhân vật brainrot viral đang làm mưa làm gió trên mạng xã hội. Bloxus có đầy đủ các nhân vật Secret cực hiếm.',
  ...
  ('anime-defenders', 'Anime Defenders', 'Secret and mythic units, gems, rerolls.',
   'Anime Defenders là đối thủ đáng gờm trong dòng game tower-defense anime, với các unit Secret, Mythic cực mạnh. Mua unit, gems và reroll ngay tại Bloxus.',
