# HƯỚNG DẪN KẾT NỐI BLOXUS VỚI SUPABASE

Bloxus cần một "cơ sở dữ liệu" để lưu tài khoản, sản phẩm, đơn hàng và tin
...
2. Đặt tên project: `bloxus` (tên gì cũng được).
...
1. Mở thư mục dự án Bloxus trên máy.
