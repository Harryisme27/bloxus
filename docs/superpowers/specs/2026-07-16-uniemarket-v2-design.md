# Uniemarket v2 — Bản thiết kế (Design Spec)

**Ngày:** 2026-07-16 · **Kế thừa:** Uniemarket v1 (demo Roblox, đã hoàn thành & verify)
...
9. UI tiếng Việt; giữ nguyên thương hiệu Uniemarket (xanh lá/vàng gold/đen) và tái sử dụng tối đa giao diện v1.
