# Bloxus — Bản thiết kế (Design Spec)
...
Bloxus là một **bản demo bấm-chạy-được** của một cửa hàng bán vật phẩm trong game Roblox
...
2. Nên để thư mục dự án **ngoài OneDrive** (ví dụ `C:\Bloxus`) để OneDrive không đồng bộ hàng nghìn file gây chậm.
...
## 3. Bộ nhận diện Bloxus (Design system)
...
- **Logo:** chữ "Bloxus" (Sora 700) + icon **khối lập phương isometric** kiểu "loot block/gem" — thân xanh,
...
- **Mascot (tùy chọn):** "Bloxus" — viên gem/slime xanh dễ thương, chỉ dùng ở khoảnh khắc vui (giỏ trống, 404, đặt hàng thành công), **không dùng** ở trang thanh toán thất bại/chính sách.
